    ...
    return (
        <section id="contact" className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-bold text-center text-red-800 mb-12">Contact Us</h2>
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl font-semibold text-red-800 mb-4">Get in Touch</h3>
                ...
                <div className="mt-12 bg-yellow-50 p-6 rounded-lg">
                    <h3 className="text-xl font-semibold text-red-800 mb-4">Conference Venue</h3>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div>
                                <h4 className="font-medium text-indigo-700 mb-2">Accommodation</h4>
